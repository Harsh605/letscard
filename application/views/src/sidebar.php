...
<!-- Top Bar End -->
<!-- ========== Left Sidebar Start ========== -->
<div class="left side-menu" style="background:linear-gradient( 
        37deg,
        #8a4e99 0%,  /* Purple shade */
        #667eea 35%, /* Blue shade */
        #64b5f6 100% /* Lighter Blue shade */
    );background-imag: url('<?= base_url('assets/images/sp_bg.png') ?>');">
    ...
    <ul class="metismenu" id="side-menu">
            ...
            <ul class="sub-menu mm-collapse">
                ...
                <li
                    ...
                    <ul class="sub-menu mm-collapse">
                        <li
                            ...
                            <a href="<?= base_url('backend/PoolTableMaster') ?>" class="waves-effect">
                        ...
                        <li
                            ...
                            <a href="<?= base_url('backend/RummyPool') ?>" class="waves-effect">
                ...
                <?php if (POINT_RUMMY == true) { ?>
                    <li class="<?= (array_filter([strpos($final_url, "backend/rummy")], 'is_numeric')) ? 'mm-active' : '' ?>">
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <span>Rummy Point Mgmt.</span>
                        </a>
                        <ul class="sub-menu mm-collapse">
                            <li class="<?= (array_filter([strpos($final_url, "backend/rummytablemaster")], 'is_numeric')) ? 'mm-active' : '' ?>">
        ...
        <?php if (PURCHASE_HISTORY == true) { ?>
         <li><a href="<?= base_url('backend/Purchase') ?>" class="waves-effect"><i class="ion ion-md-cash"></i> <span>Purchase History</span></a></li>
        <?php } ?>
        ...
        <li>
            ...
            <ul class="sub-menu mm-collapse">
                ...
                <li class="<?= (array_filter([strpos($final_url, "withdrawldashboard")], 'is_numeric')) ? 'mm-active' : '' ?>">
                        <a href="<?= base_url('backend/WithdrawlDashboard') ?>" class="waves-effect"><i class="ti-wallet"></i>
                            <span>Dashboard</span></a>
                </li>
                        <?php } ?>                          
                        <?php if (REEDEM_MANAGEMENT == true) { ?>
                <li><a href="<?= base_url('backend/WithdrawalLog/ReedemNow') ?>" class="waves-effect"><i class="ti-medall-alt"></i> <span>Management</span></a></li>
                        <?php } ?>

                        <?php if (WITHDRAWAL_LOG == true) { ?>
                <li><a href="<?= base_url('backend/WithdrawalLog') ?>" class="waves-effect"><i class="ti-stats-down"></i> <span>Withdrawal Log</span></a></li>
                        <?php } ?>
            </ul>
        </li>        
        ...
        <li>
            ...
            <ul class="sub-menu mm-collapse">
                ...
                <li><a href="<?= base_url('backend/welcomebonus') ?>" class="waves-effect"><i class="ti-medall"></i> <span>Welcome Bonus</span></a></li>
                        <?php } ?>
<?php if (GIFT_MANAGEMENT == true) { ?>
                    <li><a href="<?= base_url('backend/gift') ?>" class="waves-effect"><i class="ion ion-ios-gift"></i><span>Gift Management</span></a></li>
                <?php } ?>
                        <?php if (CHIPS_MANAGEMENT == true) { ?>
                <li><a href="<?= base_url('backend/chips') ?>" class="waves-effect"><i class="ti-shield"></i>
        ...
        <?php if (LEAD_BOARD == true) { ?>
            <li><a href="<?= base_url('backend/Game/Leaderboard') ?>" class="waves-effect"><i class="ti-cup"></i> <span>Leaderboard</span></a></li>
        <?php } ?>
        ...
        <?php if (COMISSION == true) { ?>
                <li><a href="<?= base_url('backend/Comission') ?>" class="waves-effect"><i
                            class="ion ion-ios-wallet"></i> <span>Commission</span></a></li>
        <?php } ?> 
                
        <?php if (APPBANNER == true) { ?>
                    <li><a href="<?= base_url('backend/AppBanner') ?>" class="waves-effect"><i class="ti-announcement"></i>
                            <span>App Banner</span></a></li>
        <?php } ?>
        <?php if (SETTING == true) { ?>
                    <li><a href="<?= base_url('backend/setting') ?>" class="waves-effect"><i class="ti-settings"></i> <span>Setting</span></a></li>
        <?php } ?>
    </ul>
        </div>
        <!-- Sidebar -->
                    ...
                    <div class="col-sm-6">
                        <div class="float-right d-md-block">
                            ...
                            ?>
                                ...
                                <a style="border-radius: 10px" href="<?= base_url($SideBarbutton[0]) ?>" class="btn btn-info btn-lg btn-dashboard custom-btn">
                                    <?= $SideBarbutton[1] ?></a>
