 ...
 <div id="wrapper">
     ...
     <div class="topbar">
         <!-- LOGO -->
         <div class="topbar-left" style="background:linear-gradient( 
        37deg,
        #8a4e99 0%,  /* Purple shade */
        #667eea 35%, /* Blue shade */
        #64b5f6 100% /* Lighter Blue shade */
    )!important"><a href="#" class="logo"><span style="color: white;letter-spacing:5px;font-family:Ionicons"><?= PROJECT_NAME ?></span><i><img
