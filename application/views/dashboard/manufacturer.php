<div class="row">
    ...
    <div class="col-xl-6 col-md-6">
        ...
        <select style="border:1px solid #64b5f6"  class="form-control" onchange="ChangeStatus(this.value)">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <select style="border:1px solid #64b5f6" class="form-control" onchange="ChangeRummyBotStatus(this.value)">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <select style="border:1px solid #64b5f6" class="form-control" onchange="ChangeTeenpattiBotStatus(this.value)">
