 ...
 <?php if (RUMMY_TOURNAMENT==true) { ?>
    <div class="col-xl-2 col-md-1">
        <div class="card ">
            <div class="card-body">
                <div class="mb-">
                    <h5 class="font-14 text-uppercase mt-0">Rummy Tournament</h5>
                    <input class="form-check form-switch" type="checkbox" id="tournament_rummy" name="tournament_rummy"
                        <?= $Permission->tournament_rummy ? 'checked' : ''?>
                        value="<?= $Permission->tournament_rummy ? 0 : 1 ?>" switch="none">
                    <label class="form-label" for="tournament_rummy" data-on-label="On" data-off-label="Off"></label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-2 col-md-1">
        <div class="card ">
            <div class="card-body">
                <div class="mb-">
                    <h5 class="font-14 text-uppercase mt-0">Color Prediction</h5>
