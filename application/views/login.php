...
<body  style="background-image: url('<?= base_url('assets/images/sp_bg.jpeg') ?>'); background-repeat:no-repeat;background-size:100% 100%">
    <div class="home-btn d-none d-sm-block"><a href="<?= base_url()?>" class="text-dark"><i
                class="fas fa-home h2"></i></a></div>
    <div class="wrapper-page">
        <div class="rounded card overflow-hidden account-card mx-3">
            <div class=" p-4 text-white text-center position-relative" style="background:#c09711;">
                <!-- <h4 class="font-20 m-b-5">Welcome Back !</h4> -->
                <p class="mb-4" style="color: #ffffff !important;"></p><a
                    href="#" class="logo logo-admin"><img style="border-radius:50%" class="aa" src="<?= base_url(LOGO.$Setting->logo) ?>" height="80"
                        alt="logo"></a>
            </div>
