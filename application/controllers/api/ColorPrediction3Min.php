...
class ColorPrediction3Min extends REST_Controller
{
    ...
    public function get_active_game_post()
    {
        ...
        $room = $this->ColorPrediction3Min_model->getRoom($this->data['room_id'], $this->data['user_id']);
        if (empty($room)) {
    ...
    public function cancel_bet_post()
    {
        ...
        if ($this->ColorPrediction3Min_model->DeleteBet($bet[0]->id, $this->data['user_id'], $this->data['game_id'])) {
